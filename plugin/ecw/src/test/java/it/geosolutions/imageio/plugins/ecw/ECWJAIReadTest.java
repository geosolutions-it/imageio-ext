...
public class ECWJAIReadTest extends AbstractECWTestCase{
	 ...
	 * @throws IOException
	 */
	public void testGrayScaleImageRead() throws FileNotFoundException, IOException {
		final ParameterBlockJAI pbjImageRead;
		final ImageReadParam irp = new ImageReadParam();
	...
	public static Test suite() {
		...
		// Test read exploiting a simple JAI's Crop operation
//		suite.addTest(new ECWJAIReadTest("testCrop"));
