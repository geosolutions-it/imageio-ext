 ...
 */
public class CogReadTest extends Assert {
    ...
    public void readCog() throws IOException {
        CogImageInputStream cogStream = new HttpCogImageInputStream(cogUrl);
    ...
    public void readCogCaching() throws IOException {
        CogImageInputStream cogStream = new CachingHttpCogImageInputStream(cogUrl);
        CogImageReader reader = new CogImageReader(new CogImageReaderSpi());
        reader.setInput(cogStream);
    ...
    public void readFromFileJAI() throws IOException {
        ...
        RenderedImage image = ImageReadDescriptor.create(new FileImageInputStream(file),
                ...
                new CogImageReaderSpi().createReaderInstance(), null);
    ...
    public void readFromFileDirect() throws IOException {
        ...
        final CogImageReader reader = (CogImageReader) new CogImageReaderSpi()
    ...
    public void readTIFFTurboJpegNoJpegTables() throws IOException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        ...
        final CogImageReader reader = (CogImageReader) new CogImageReaderSpi().createReaderInstance();
