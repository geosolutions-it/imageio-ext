...
public class TIFFReadTest extends Assert {
    ...
    public void readExternalMasks() throws IOException {
        ...
        ImageInputStream inputStream = new FileImageInputStreamExtImpl(file);
        try {
            // reading phase
            reader.setInput(inputStream);
            // IMAGE 0
    ...
    @Test
    public void readMultiBandPredictor2() throws IOException {
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA_LZW_p2.tif"));
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA_DEFLATE_p2.tif"));
    }

    @Test
    public void readMultiBandInt16Predictor2() throws IOException {
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA16_LZW_p2.tif"));
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA16_DEFLATE_p2.tif"));
    }

    @Test
    public void readMultiBandInt32Predictor2() throws IOException {
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA32_LZW_p2.tif"));
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA32_DEFLATE_p2.tif"));
    }

    @Test
    public void readMultiBandFloat32Predictor2() throws IOException {
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA32f_LZW_p2.tif"));
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA32f_DEFLATE_p2.tif"));
    }

    @Test
    public void readMultiBandFloat32Predictor3() throws IOException {
        assertImagesEqual(readTiff("sampleRGBA.tif"), readTiff("sampleRGBA32f_LZW_p3.tif"));
