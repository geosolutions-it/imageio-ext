...
public class TIFFWriteTest extends Assert {
    ...
    private static final Logger LOGGER = Logger.getLogger(TIFFWriteTest.class.toString());
    ...
    public void readWriteFromFileDirect() throws IOException {
        ...
        //                reader, new RenderingHints(ImageN.KEY_IMAGE_LAYOUT, new
