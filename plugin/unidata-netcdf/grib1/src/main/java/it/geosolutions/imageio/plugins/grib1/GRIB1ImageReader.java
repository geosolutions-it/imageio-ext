 ...
 */
public class GRIB1ImageReader extends UcarImageReader {
    ...
    class GribVariableWrapper extends BaseVariableWrapper {
        ...
        public GribVariableWrapper( final Variable variable, final Range range ) {
            ...
            for( Dimension dim : dimensions ) {
                ...
                final Variable coordinate = getDataset().findVariable(dimName);
                if (coordinate != null) {
                    ...
                    if (bounds != null) {
                        ...
                        final Variable boundVar = getDataset().findVariable(boundName);
                        if (boundVar != null) {
    ...
    public void setInput( Object input, boolean seekForwardOnly, boolean ignoreMetadata ) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error occurred during Grib file opening", e);
        }
