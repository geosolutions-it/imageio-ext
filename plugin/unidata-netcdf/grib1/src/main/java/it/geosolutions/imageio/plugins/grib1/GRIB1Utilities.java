...
public class GRIB1Utilities {
    ...
    private static final ColorModel INT_COLOR_MODEL = buildColorModel(DataBuffer.TYPE_INT);

    private static final ColorModel SHORT_COLOR_MODEL = buildColorModel(DataBuffer.TYPE_USHORT);

    private static final ColorModel FLOAT_COLOR_MODEL = buildColorModel(DataBuffer.TYPE_FLOAT);

    private static final ColorModel DOUBLE_COLOR_MODEL = buildColorModel(DataBuffer.TYPE_DOUBLE);
    ...
    static final String GRIB_PARAM_UNIT = NetCDFUtilities.UNITS;
    ...
    public static String getValuesAsString(Variable variable, int[] indexes) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (size > 1 && i != size - 1) sb.append(VALUES_SEPARATOR);
            }
