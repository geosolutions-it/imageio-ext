...
public class HDF4APSProperties {
    ...
    public static final HDF4APSProperties.APSProducts apsProducts = new HDF4APSProperties.APSProducts();
    ...
    public static final String[] STD_FA_ATTRIB = new String[] {
        STD_FA_FILE,
    ...
    public static final String[] STD_TA_ATTRIB = new String[] {
    ...
    public static final String[] STD_SA_ATTRIB = new String[] {
        STD_SA_SENSOR,
    ...
    public static final String[] PFA_IPA_ATTRIB = new String[] {
    ...
    public static final String[] PFA_NA_ATTRIB = new String[] {
        PFA_NA_NAVTYPE,
    ...
    /** */
    public static final String[] PFA_IGCA_ATTRIB = new String[] {
    ...
    /**
     * This is a space delimited string of additional units available for this product. For example, an sst product may
     * set this string to "Kelvin Fahrenheit"
     */
    ...
    /**
     * This is a suggested function to apply to convert the data in the SDS into an image. A value of 1 indicates linear
     * scaling; a value of 2 indicates log10 scaling.
     */
    public static final String PDSA_BROWSEFUNC = "browseFunc";

    /**
     * This is a suggested display range when converting the data in the SDS into an image. This may or may not be the
     * same as validRange because in some cases (e.g. rrs_412), the data has been known to fall outside the range, but
     * we wish to display the invalid data. This attribute is used by the APS program imgBrowse when creating quick-look
     * browse images of different products.
     */
    public static final String PDSA_BROWSERANGES = "browseRanges";

    /** Product dataset attributes Array */
    public static final String[] PDSA_ATTRIB = new String[] {
        PDSA_CREATESOFTWARE,
        PDSA_CREATETIME,
        PDSA_CREATEPLATFORM,
        PDSA_PRODUCTNAME,
    ...
    /**
     * Build an ISO8601 formatted time from an input <code>String</code> representing time in the form: "DAY_OF_THE_WEEK
     * MONTH_NAME MONTH_DAY TIME YEAR"
     *
    ...
    public static final String buildISO8601Time(String time) {
        ...
        final String iso8601Time = new StringBuffer(times[4])
                .append("-")
                .append(getMonthNumber(times[1]))
                .append("-")
                .append(times[2])
                .append("T")
                .append(times[3])
     ...
     *
     * @param monthName the input month name.
    ...
    public static final String getMonthNumber(String monthName) {
        ...
        else if (monthName.equalsIgnoreCase("FEB")) return "02";
        else if (monthName.equalsIgnoreCase("MAR")) return "03";
        else if (monthName.equalsIgnoreCase("APR")) return "04";
        else if (monthName.equalsIgnoreCase("MAY")) return "05";
        else if (monthName.equalsIgnoreCase("JUN")) return "06";
        else if (monthName.equalsIgnoreCase("JUL")) return "07";
        else if (monthName.equalsIgnoreCase("AUG")) return "08";
        else if (monthName.equalsIgnoreCase("SEP")) return "09";
        else if (monthName.equalsIgnoreCase("OCT")) return "10";
        else if (monthName.equalsIgnoreCase("NOV")) return "11";
        else if (monthName.equalsIgnoreCase("DEC")) return "12";
        else throw new IllegalArgumentException("Unsupported month name" + monthName);
    }
    ...
    private static boolean isAcceptedItem(String productName) {
        if (productName.endsWith("_flags")) return false;
        if (HDF4APSProperties.apsProducts.get(productName) != null) return true;
        return false;
    }
}
