...
public class HDF4TeraScanImageMetadata extends BaseImageMetadata {
    public static final String nativeMetadataFormatName =
            "it_geosolutions_imageio_plugins_hdf4_terascan_terascanImageMetadata_1.0";
    ...
    public HDF4TeraScanImageMetadata(final BaseImageReader reader, final int imageIndex) {
    ...
    public Node getAsTree(String formatName) {
        if (HDF4TeraScanImageMetadata.nativeMetadataFormatName.equalsIgnoreCase(formatName)) return createNativeTree();
