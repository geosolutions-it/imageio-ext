...
public class ColorRampGenerator {
    ...
    /**
     * Return a RGB colour value given a scalar v in the range [vmin,vmax] In this case each colour component ranges
     * from 0 (no contribution) to 1 (fully saturated), modifications for other ranges is trivial. The colour is clipped
     * at the end of the scales if v is outside the range [vmin,vmax]
     */
    ...
    public static void main(String[] args) {
        ...
        for (int c = 0; c <= intervals; c++) {
            ...
            String hexColor =
                    (r.length() == 2 ? r : "0" + r) + (g.length() == 2 ? g : "0" + g) + (b.length() == 2 ? b : "0" + b);
