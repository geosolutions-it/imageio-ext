...
public class MercatorOceanConverter {
    ...
    private static final ArrayList<String> VARIABLES = new ArrayList<String>(4);
    ...
    private static final Logger LOGGER = Logger.getLogger("it.geosolutions.processing.node.worker.netcdf");
    ...
    private static final String fileNameIn =
            "C:\\Work\\data\\rixen\\lsvc08\\mercator-ocean\\PSY2V3R1\\20080924\\ext-mercatorPsy2v3R1v_med_mean_20080926_R20080924.nc";

    private static final String fileNameOut =
            "C:/work/data/rixen/converted/re_converted_ext-mercatorPsy2v3R1v_med_mean_20080926_R20080924.nc";
    ...
    private void run(String fileNameIn, String fileNameOut) {
        try {
            ...
            final Variable depthOriginalVar = ncFileIn.findVariable(NetCDFUtilities.DEPTH); // Depth
            ...
            if (positiveAttrib != null) positiveValue = positiveAttrib.getStringValue();
            ...
            for (int i = 0; i < numVars; i++) {
                ...
                ArrayFloat tempData =
                        new ArrayFloat(new int[] {latOriginalDim.getLength(), lonOriginalDim.getLength()});
                ...
                if (hasLocalDepth) {
                        ...
                        for (int yPos = 0; yPos < latOriginalDim.getLength(); yPos++) {
                            for (int xPos = 0; xPos < lonOriginalDim.getLength(); xPos++) {
                                tempData.setFloat(
                                        ...
                                        originalData.getFloat(varIndex.set(levelPos, yPos, xPos)));
                            }
                        }
                    ...
                    for (int yPos = 0; yPos < latOriginalDim.getLength(); yPos++) {
                        for (int xPos = 0; xPos < lonOriginalDim.getLength(); xPos++) {
                            tempData.setFloat(
                                    tempIndex.set(yPos, xPos), originalData.getFloat(varIndex.set(yPos, xPos)));
                        }
                    }
    ...
    private int setTime(NetcdfFileWriteable ncFileOut, final Attribute referenceTime, final Attribute forecastDate) {
        ...
        try {
            ...
            final StringBuffer sbTime = new StringBuffer(year)
                    ...
                    .append(".")
                    .append(millisecond);
            ncFileOut.addVariableAttribute(NetCDFUtilities.TIME, "units", "days since " + sbTime.toString());
            ncFileOut.addVariableAttribute(NetCDFUtilities.TIME, "long_name", "time");
        ...
        if (forecastDays != null) {
            ...
            return numDay;
        } else throw new IllegalArgumentException("Unable to find forecast day");
    }
