 ...
 */
public abstract class UcarImageReaderSpi extends ImageReaderSpi {
	...
	protected static final Logger LOGGER = Logger.getLogger(UcarImageReaderSpi.class.toString());
	
	protected static final String vendorName = "GeoSolutions";

	public UcarImageReaderSpi() {
		super();
	}

	public UcarImageReaderSpi(String vendorName, String version,
