 ...
 */
public abstract class UcarImageMetadata extends CoreCommonImageMetadata {

    public final static String ATTRIBUTES_NODE = "Attributes";

    protected final UcarImageReader imageReader;
     ...
     */
    protected UcarImageMetadata(UcarImageReader reader, int imageIndex) {
    ...
    protected void setMembers(final UcarImageReader imageReader) throws IOException {
