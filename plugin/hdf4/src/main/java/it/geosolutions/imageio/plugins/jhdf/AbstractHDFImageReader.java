...
public abstract class AbstractHDFImageReader extends BaseImageReader {
	...
	protected class HDFDatasetWrapper{
        ...
        protected HDFDatasetWrapper(final Variable var) {
...
//            final int chunkSizes[] = variable.getChunkSizes();
	...
	protected abstract HDFDatasetWrapper getDatasetWrapper(final int imageIndex);
    ...
    public Iterator<ImageTypeSpecifier> getImageTypes(int imageIndex) throws IOException {
        ...
        final HDFDatasetWrapper ds = getDatasetWrapper(imageIndex);
    ...
    public String getAttributeAsString(final int imageIndex, final String attributeName,
        ...
        final HDFDatasetWrapper wrapper = getDatasetWrapper(imageIndex);
