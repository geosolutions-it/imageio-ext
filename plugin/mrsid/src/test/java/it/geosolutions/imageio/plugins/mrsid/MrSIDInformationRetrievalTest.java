...
//		for (int i = 0; i < 50; i++) {
			...
			final File file = //TestData.file(this, fileName);
			 new
				 File("F:\\work\\data\\mrsid\\landsat\\N-32-40_2000\\N-32-40_2000.sid");
//			irp.setSourceSubsampling(32, 32, 0, 0);
			pbjImageRead = new ParameterBlockJAI("ImageRead");
			pbjImageRead.setParameter("Input", file);
			pbjImageRead.setParameter("readParam", irp);
			RenderedOp image = JAI.create("ImageRead", pbjImageRead);
...
//		}
	...
	public static Test suite() {
		...
		// suite.addTest(new
		// MrSIDInformationRetrievalTest("testReadAndProjections"));

		// Visualize Image and provides to retrieve metadata
		// suite.addTest(new
		// MrSIDInformationRetrievalTest("testReadAndMetadata"));
