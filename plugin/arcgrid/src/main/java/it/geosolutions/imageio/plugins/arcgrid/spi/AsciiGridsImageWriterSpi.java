...
/**
 * Class which provides a specialized Service Provider Interface which instantiates an {@link AsciiGridsImageReader} if
 * it is able to decode the input provided.
 *
