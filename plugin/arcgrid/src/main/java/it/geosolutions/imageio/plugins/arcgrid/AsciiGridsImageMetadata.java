...
public final class AsciiGridsImageMetadata extends IIOMetadata {
    /**
     * Two available values to define raster space as defined in GeoTiff specifications. <br>
     *
     * @see <a href="http://www.remotesensing.org/geotiff/spec/geotiff2.5.html#2.5.2.2">GeoTiff specifications:
     *     RasterSpace</a>
     */
    ...
    /** the rasterSpace Type which is one of the values contained in <code>rasterSpaceTypes</code> array */
    private RasterSpaceType rasterSpaceType = null;

    private AsciiGridRasterType rasterFileType;

    /**
     * A constructor which uses an input {@link AsciiGridRaster} to initialize metadata fields
     *
     * @param raster input {@link AsciiGridRaster} used to retrieve properties to set inner fields
     */
     ...
     * @param cellsizeX the x size of the grid cell
     * @param cellsizeY the y size of the grid cell
     * @param xll the xllCellCoordinate of the Bounding Box
     * @param yll the yllCellCoordinate of the Bounding Box
     * @param isCorner true if xll represents the xllCorner
     * @param grass true if the Ascii grid is Grass
     ...
     * @return
     * @throws IllegalArgumentException if the formatName is not one of the supported format names
     */
     ...
     *
     * @param formatName DOCUMENT ME!
     * @return DOCUMENT ME!
     * @throws IllegalArgumentException DOCUMENT ME!
     */
    public IIOMetadataFormat getMetadataFormat(String formatName) {
        if (formatName.equals(nativeMetadataFormatName)) return new AsciiGridsImageMetadataFormat();
     ...
     *
     * @param inputRaster the input {@link AsciiGridRaster} used to initialize fields.
     */
    private void inizializeFromRaster(AsciiGridRaster inputRaster) {
        if (inputRaster != null) {
            ...
            } else rasterSpaceType = RasterSpaceType.PixelIsPoint;
        ...
        } else throw new NullPointerException("Null inputRaster provided.");
    }
