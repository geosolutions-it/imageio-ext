...
final class GrassAsciiGridRaster extends AsciiGridRaster {
     ...
     *
     * @param iis ImageInputStream needed to read the raster.
     */
     ...
     * Creates a new instance of GrassAsciiGridRaster.
     *
     * @param ios ImageOutputStream needed to write the raster.
     */
    ...
    public void parseHeader() throws IOException {
        ...
        double east = 0;
        double west = 0;
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.info("Header Parsed: ");
        ...
        while (keepParsing) {
            ...
            if (sKey == null | sKey.length() == 0 || sKey == "") break;
            ...
            if (Double.isNaN(value) || Double.isNaN(value)) break;
     ...
     *
     * @param columnsString A String representing the number of columns
     * @param rowsString A String representing the number of rows
     * @param xllString A String representing the xllCorner of the Bounding Box
     * @param yllString A String representing the yllCorner of the Bounding Box
     * @param cellsizeString A String representing the size of the grid cell
     * @param rasterSpaceType Not interesting in GRASS rasters
     * @param noDataValue Not interesting in GRASS rasters
    ...
    public void writeHeader(
            ...
            String xllString,
            String yllString,
            String cellsizeStringX,
            String cellsizeStringY,
        ...
        //
        // //
        imageOS.writeBytes(new StringBuffer(NORTH)
                .append(" ")
                .append(Double.toString(north))
                .append(newline)
                .toString());
        imageOS.writeBytes(new StringBuffer(SOUTH)
                .append(" ")
                .append(Double.toString(south))
                .append(newline)
                .toString());
        imageOS.writeBytes(new StringBuffer(EAST)
                .append(" ")
                .append(Double.toString(east))
                .append(newline)
                .toString());
        imageOS.writeBytes(new StringBuffer(WEST)
                .append(" ")
                .append(Double.toString(west))
                .append(newline)
                .toString());
        imageOS.writeBytes(new StringBuffer(ROWS)
                .append(" ")
                .append(rowsString)
                .append(newline)
                .toString());
        imageOS.writeBytes(new StringBuffer(COLS)
                .append(" ")
    ...
    /**
     * return the <code>String</code> representing a noData value. In GRASS format, NoDataMarker is always the '*' sign.
     */
