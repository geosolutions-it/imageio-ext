...
import it.geosolutions.imageio.plugins.javaarcgrid.raster.AsciiGridRaster;
import it.geosolutions.imageio.plugins.javaarcgrid.raster.EsriAsciiGridRaster;
import it.geosolutions.imageio.plugins.javaarcgrid.raster.GrassAsciiGridRaster;
...
public final class AsciiGridsImageReaderSpi extends ImageReaderSpi {
	...
	static final String readerCN = "it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageReader";

	static final String vendorName = "GeoSolutions";

	// writerSpiNames
	static final String[] wSN = { "it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageWriterSpi" };
