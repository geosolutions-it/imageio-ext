...
public final class AsciiGridsImageMetadata extends IIOMetadata {
	...
	public static final String nativeMetadataFormatName = "it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageMetadata_1.0";
	...
	public AsciiGridsImageMetadata() {
		super(
				...
				"it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageMetadataFormat",
				null, null);
	}
