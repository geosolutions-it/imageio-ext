 ...
 */
package it.geosolutions.imageio.plugins.javaarcgrid.spi;

import it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageReader;
import it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageWriter;
...
public final class AsciiGridsImageWriterSpi extends ImageWriterSpi {
	...
	static final String writerCN = "it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageWriter";

	static final String vendorName = "GeoSolutions";

	// ReaderSpiNames
	static final String[] rSN = { "it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageReaderSpi" };
	...
	static final String nativeImageMetadataFormatName = "it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageMetadata_1.0";

	static final String nativeImageMetadataFormatClassName = "it.geosolutions.imageio.plugins.javaarcgrid.AsciiGridsImageMetadataFormat";
