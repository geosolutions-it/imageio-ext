...
public class EXIFUtilities {
    ...
    /**
     * Update the EXIF content referred by a {@link FileImageInputStreamExt} using the content available in the
     ...
     * @param inputStream a {@link FileImageInputStreamExt} referring to a file containing EXIF metadata to be updated
    ...
    /**
     * Replace the EXIF contained within a file referred by a {@link FileImageInputStreamExt} instance with the EXIF
    ...
    private static EXIFMetadataWrapper parseExifMetadata(
            final FileImageInputStreamExt inputStream, final EXIFMetadata exif) throws IOException {
