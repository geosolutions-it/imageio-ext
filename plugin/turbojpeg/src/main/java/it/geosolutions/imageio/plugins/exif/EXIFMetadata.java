 ...
 *     <p>Class representing EXIF entity in terms of list of baseline TIFF Tags and specific EXIF tags.
 */
public class EXIFMetadata {
    ...
    //
    /**
     * In order to minimize inner checks, make sure that the elements in each list are provided in ascending order, as
     * requested by the EXIF specification.
     *
     * @param baselineExifTags a {@link List} containing baseline TIFF tags elements, already sorted in ascending order.
     * @param exifTags a {@link List} containing EXIF TIFF tags elements, already sorted in ascending order.
     */
    ...
    /**
     * In order to minimize inner checks, make sure that the elements in each list of the map are provided in ascending
     * order, as requested by the EXIF specification.
     *
    ...
    /**
     * Set the specified TAG of the specified list, with the specified content. The TAG needs to be already present
     * within the list. No Tags will be added to the list if missing. The content set will also update the count value.
     *
     ...
     */
    public void setTag(final int tagNumber, final Object content, final Type tagType) {
