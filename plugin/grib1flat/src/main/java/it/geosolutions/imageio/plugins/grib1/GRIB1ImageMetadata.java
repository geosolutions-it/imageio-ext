    ...
    private Node createNativeTree() {
        ...
        if (imageReader instanceof GRIB1ImageReader) {
            ...
            try {
                ...
                gdsNode.setAttribute(GRID_DELTA_X, Double.toString(flatReader
                        .getGridDeltaX(imageIndex)));
                gdsNode.setAttribute(GRID_DELTA_Y, Double.toString(flatReader
                        .getGridDeltaY(imageIndex)));
                gdsNode.setAttribute(GRID_N_X, Double.toString(flatReader
                        .getWidth(imageIndex)));
                gdsNode.setAttribute(GRID_N_Y, Double.toString(flatReader
                        .getHeight(imageIndex)));
                gdsNode.setAttribute(GRID_LON_1, Double.toString(flatReader
                        .getGridLon1(imageIndex)));
                gdsNode.setAttribute(GRID_LAT_1, Double.toString(flatReader
                        .getGridLat1(imageIndex)));
                gdsNode.setAttribute(GRID_LON_2, Double.toString(flatReader
                        .getGridLon2(imageIndex)));
                gdsNode.setAttribute(GRID_LAT_2, Double.toString(flatReader
                        .getGridLat2(imageIndex)));
                gdsNode.setAttribute(GRID_LON_SP, Double.toString(flatReader
                        .getGridLonSP(imageIndex)));
                gdsNode.setAttribute(GRID_LAT_SP, Double.toString(flatReader
                        .getGridLatSP(imageIndex)));
                gdsNode.setAttribute(GRID_ROTATION_ANGLE, Double
                        .toString(flatReader.getGridRotationAngle(imageIndex)));

                switch (gridType) {
                case 3:
                    gdsNode.setAttribute(GRID_STARTX, Double
                            .toString(flatReader.getGridStartX(imageIndex)));
                    gdsNode.setAttribute(GRID_STARTY, Double
                            .toString(flatReader.getGridStartY(imageIndex)));
                    gdsNode.setAttribute(GRID_LATIN_1, Double
                            .toString(flatReader.getGridLatin1(imageIndex)));
                    gdsNode.setAttribute(GRID_LATIN_2, Double
                            .toString(flatReader.getGridLatin2(imageIndex)));
                    gdsNode.setAttribute(GRID_LOV, Double.toString(flatReader
                            .getGridLov(imageIndex)));

                    break;
                case 10:
                    gdsNode.setAttribute(GRID_LON_SPST, Double
                            .toString(flatReader.getGridLonSPST(imageIndex)));
                    gdsNode.setAttribute(GRID_LAT_SPST, Double
                            .toString(flatReader.getGridLatSPST(imageIndex)));
                }
                ...
                if (params != null) {
                    pdsNode.setAttribute(PROD_PARAMTABLE_CENTERID, Integer
                            .toString(params[0]));
                    pdsNode.setAttribute(PROD_PARAMTABLE_SUBCENTERID, Integer
                            .toString(params[1]));
                    pdsNode.setAttribute(PROD_PARAMTABLE_TABLEVERSION, Integer
                            .toString(params[2]));
                    pdsNode.setAttribute(PROD_PARAMTABLE_PARAMETERNUMBER,
                            Integer.toString(params[3]));
                }
                root.appendChild(pdsNode);
                IIOMetadataNode pdsLevelNode = new IIOMetadataNode(PDS_LEVEL);
                pdsLevelNode.setAttribute(PDSL_ID, flatReader
                        .getPDSLevelIndex(imageIndex));
                pdsLevelNode.setAttribute(PDSL_NAME, flatReader
                        .getPDSLevelName(imageIndex));
                pdsLevelNode.setAttribute(PDSL_DESCRIPTION, flatReader
                        .getPDSLevelDescription(imageIndex));
                pdsLevelNode.setAttribute(PDSL_UNITS, flatReader
                        .getPDSLevelUnits(imageIndex));
                pdsLevelNode.setAttribute(PDSL_LEVEL, flatReader
                        .getPDSLevelShortName(imageIndex));
                pdsLevelNode.setAttribute(PDSL_ISNUMERIC, flatReader
                        .getPDSLevelIsNumeric(imageIndex));
                pdsLevelNode.setAttribute(PDSL_VALUES, flatReader
                        .getPDSLevelValues(imageIndex));
