...
/**
 * {@link MrSIDImageReader} is a {@link GDALImageReader} able to create {@link RenderedImage} from MrSID files.
 *
...
public class MrSIDImageReader extends GDALImageReader {
    ...
    protected GDALCommonIIOImageMetadata createDatasetMetadata(
            Dataset ds, String datasetName, boolean initializationRequired) {
    ...
    public MrSIDImageReader(MrSIDImageReaderSpi originatingProvider) {
        ...
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.fine("MrSIDImageReader Constructor");
    }
}
