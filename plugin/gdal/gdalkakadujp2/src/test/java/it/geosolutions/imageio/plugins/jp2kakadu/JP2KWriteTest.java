 ...
 *
 * TODO: we need to rewrite this test using straight image writers. Sugegsted approach:
 * - factor our a method to centralize writing code, which is repeated over and over (there is an example below)
 * - switch that one method to use straight writers
 * The issue here is, being able to run this test at all, it requires a Kakadu installation, and a GDAL
 * build with Kakadu support.
 *
 */
