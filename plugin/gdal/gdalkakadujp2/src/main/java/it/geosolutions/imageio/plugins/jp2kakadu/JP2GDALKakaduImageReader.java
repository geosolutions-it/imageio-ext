...
/**
 * {@link JP2GDALKakaduImageReader} is a {@link GDALImageReader} able to create {@link RenderedImage} from JP2K files.
 *
...
public class JP2GDALKakaduImageReader extends GDALImageReader {
    ...
    public JP2GDALKakaduImageReader(JP2GDALKakaduImageReaderSpi originatingProvider) {
        ...
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.fine("JP2GDALKakaduImageReader Constructor");
    }
}
