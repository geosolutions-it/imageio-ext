...
public class JP2GDALKakaduImageReaderSpi extends GDALImageReaderSpi {
    ...
    public JP2GDALKakaduImageReaderSpi() {
        ...
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.fine("JP2GDALKakaduImageReaderSpi Constructor");
    }
     ...
     * @deprecated use {@link #setKakaduInputErrorManagement(KakaduErrorManagementType)}
     */
    public static final void setKakaduInputErrorManagement(final int errorManagement) {
        switch (errorManagement) {
            ...
            default:
                throw new IllegalArgumentException(
                        "KAKADU_ERROR_LEVEL_MANAGEMENT unknown! Provided value is " + errorManagement);
        }
    }
     ...
     * @param errorManagement
     */
    public static final void setKakaduInputErrorManagement(final KakaduErrorManagementType errorManagement) {
        switch (errorManagement) {
            case FAST:
                gdal.SetConfigOption("KAKADU_ERROR_LEVEL_MANAGEMENT", "FAST");
                break;
