...
public class JP2GDALKakaduImageWriteParam extends GDALImageWriteParam {
     ...
     * QUALITY=n: Set the compressed size ratio as a percentage of the size of the uncompressed image. The default is 20
     * indicating that the resulting image should be 20% of the size of the uncompressed image. A value of 100 will
     * result in use of the lossless compression algorithm . Actual final image size may not exactly match that
     * requested depending on various factors.<br>
     ...
     * GMLJP2=YES/NO: Indicates whether a GML box conforming to the OGC GML in JPEG2000 specification should be included
     * in the file. Defaults to YES.<br>
     * GeoJP2=YES/NO: Indicates whether a GML box conforming to the GeoJP2 (GeoTIFF in JPEG2000) specification should be
     * included in the file. Defaults to YES.<br>
     * LAYERS=n: Control the number of layers produced. These are sort of like resolution layers, but not exactly. The
     * default value is 12 and this works well in most situations.<br>
     * ROI=xoff,yoff,xsize,ysize: Selects a region to be a region of interest to process with higher data quality. The
     * various "R" flags below may be used to control the amount better. For example the settings "ROI=0,0,100,100",
     * "Rweight=7" would encode the top left 100x100 area of the image with considerable higher quality compared to the
     * rest of the image.<br>
     * COMSEG=YES/NO: Indicates wheter a comment segment should be emitted during the flushing of the written
     * codestream. Defaults to YES.
     *
     * <p>FLUSH=YES/NO: Indicates wheter multiple flush operations should be enabled during tiles writing. Defaults to
     * YES.
     */
     ...
     *
     * @param quality the compressed size ratio as a percentage of the size of the uncompressed image.
     */
