...
/**
 * Service provider interface for the VRT image reader
 * 
...
public class VRTImageReaderSpi extends GDALImageReaderSpi {
    ...
    static final String[] MIMETypes = { "image/vrt" };

    static final String version = "1.0";
    
    static final String description = "VRT Coverage Reader, version " + version;
    ...
    /**
     * Returns an instance of the VRTImageReader
     * 
