...
/**
 * Testing reading capabilities for Idrisi Raster with {@link VRTImageReader}.
 * 
 * @author Simone Giannecchini, GeoSolutions.
 * @author Daniele Romagnoli, GeoSolutions.
 * 
 */
public class IdrisiReadVrtTest extends AbstractGDALTest {
	public IdrisiReadVrtTest() {
		super();
	}
	...
	public void readImageIO() throws FileNotFoundException, IOException {
		...
		TestData.unzipFile(this, "idrisi.zip");
		final File file = TestData.file(this, "idrisi.rst.vrt");
