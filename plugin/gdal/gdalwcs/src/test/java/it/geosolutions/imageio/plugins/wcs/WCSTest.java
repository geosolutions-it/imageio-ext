...
public class WCSTest extends AbstractGDALTest {
    public static final String fileName = "wcs.xml";

    private static final boolean isDriverAvailable = isGDALAvailable && GDALUtilities.isDriverAvailable("WCS");
    ...
    public void read() throws FileNotFoundException, IOException {
        ...
        // preparing to read
        // ////////////////////////////////////////////////////////////////
        final ImageReader mReader = new WCSImageReaderSpi().createReaderInstance();
