...
/**
 * {@link DOQ1ImageReader} is a {@link GDALImageReader} able to create {@link RenderedImage} from Digital Orthophoto
 * Quarter Quadrangles files.
 *
...
public class DOQ1ImageReader extends GDALImageReader {
    ...
    public DOQ1ImageReader(final DOQ1ImageReaderSpi originatingProvider) {
        ...
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.fine("DOQ1ImageReader Constructor");
    }
}
