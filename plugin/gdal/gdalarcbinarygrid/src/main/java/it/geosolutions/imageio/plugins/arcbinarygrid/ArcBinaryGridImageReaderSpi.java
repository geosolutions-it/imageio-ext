...
public class ArcBinaryGridImageReaderSpi extends GDALImageReaderSpi {
    ...
    private static final Logger LOGGER = Logger.getLogger(ArcBinaryGridImageReaderSpi.class.toString());
    ...
    public ArcBinaryGridImageReaderSpi() {
        ...
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.fine("ArcBinaryGridImageReaderSpi Constructor");
    }
