...
/**
 * {@link JP2GDALEcwImageReader} is a {@link GDALImageReader} able to create {@link RenderedImage} from JP2K files.
 *
...
public class JP2GDALEcwImageReader extends GDALImageReader {
    ...
    public JP2GDALEcwImageReader(JP2GDALEcwImageReaderSpi originatingProvider) {
        ...
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.fine("JP2GDALEcwImageReader Constructor");
    }
}
