 ...
 */
public class RPFTOCImageReaderSpi extends GDALImageReaderSpi {
    ...
    // related to RPFTOC files.
    static final String[] suffixes = {"TOC"};

    static final String[] formatNames = {"RPFTOC"};

    static final String[] MIMETypes = {"image/rpftoc"};

    static final String version = "1.0";

    static final String description = "RPFTOC Image Reader, version " + version;

    static final String readerCN = "it.geosolutions.imageio.plugins.rpftoc.RPFTOCImageReader";
    ...
    public RPFTOCImageReaderSpi() {
        super(
                ...
                Collections.singletonList("RPFTOC"));
    ...
    public ImageReader createReaderInstance(Object source) throws IOException {
        return new RPFTOCImageReader(this);
    }
