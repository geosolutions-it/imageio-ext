...
public class ArcGridImageReaderSpi extends GDALImageReaderSpi {
    ...
    private static final Logger LOGGER = Logger.getLogger(ArcGridImageReaderSpi.class.toString());
    ...
    static final String[] wSN = {
        /* "it.geosolutions.imageio.plugins.arcgrid.ArcGridImageReaderSpi" */
        null
    };
    ...
    public ArcGridImageReaderSpi() {
        ...
        if (LOGGER.isLoggable(Level.FINE)) LOGGER.fine("ArcGridImageReaderSpi Constructor");
    }
