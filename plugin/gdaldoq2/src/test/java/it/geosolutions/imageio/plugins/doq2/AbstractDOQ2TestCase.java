 ...
 */
public class AbstractDOQ2TestCase extends TestCase {

    protected static final String fileName = "C3607614_truncated.NWS";
    ...
    public AbstractDOQ2TestCase(String name) {
        super(name);
    }
