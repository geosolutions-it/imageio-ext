...
/**
 * An object containing elementary information for a reading access on a source,
 * represented by the SPI to get an ImageReader as well as the SPI to
 * get an ImageInputStream on top of that source.
 */
