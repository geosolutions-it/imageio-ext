...
/**
 * Class defining the structure of metadata documents describing common stream metadata returned from <code>getAsTree
 * </code> method.
 *
...
public class CoreCommonIIOStreamMetadataFormat extends IIOMetadataFormatImpl {
    ...
    /** A single instance of the <code>GDALCommonIIOStreamMetadataFormat</code> class. */
    ...
    /**
     * Returns an instance of the <code>CoreCommonIIOStreamMetadataFormat</code> class. We build only a single instance
     * and we cache it for future uses.
     *
     * @return an instance of the <code>CoreCommonIIOStreamMetadataFormat</code> class.
     */
    public static synchronized IIOMetadataFormat getInstance() {
        if (theInstance == null) theInstance = new CoreCommonIIOStreamMetadataFormat();
        return theInstance;
    }
