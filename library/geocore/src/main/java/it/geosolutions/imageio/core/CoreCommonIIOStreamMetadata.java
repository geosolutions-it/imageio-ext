...
public class CoreCommonIIOStreamMetadata extends IIOMetadata {
    ...
    /**
     * The name of the class implementing <code>IIOMetadataFormat</code> and representing the native metadata format for
     * this object.
     */
    ...
    /**
     * Public constructor for common stream metadata object. It builds a proper {@link CoreCommonIIOStreamMetadata}
     * object given the dataset names available within the underlying stream.
     *
     * @param datasetNames the dataset names available within the datasource.
     */
     ...
     *     is the {@link CoreCommonIIOStreamMetadata#nativeMetadataFormatName}. Requesting other format names will
     *     result in an <code>IllegalArgumentException</code>
     */
    public Node getAsTree(String formatName) {
        if (!nativeMetadataFormatName.equalsIgnoreCase(formatName))
            throw new IllegalArgumentException(
                    formatName + " is not a recognized format name for gdal stream metadata.");
