...
/**
 * An implementation of {@link ImageOutputStream} that take its output on a {@link File}.
 *
...
public class FileImageOutputStreamExtImpl extends ImageOutputStreamImpl implements FileImageOutputStreamExt {
    ...
    /**
     * Sets the current stream position and resets the bit offset to 0. It is legal to seeking past the end of the eraf;
     * an <code>EOFException</code> will be thrown only if a read is performed. The eraf length will not be increased
