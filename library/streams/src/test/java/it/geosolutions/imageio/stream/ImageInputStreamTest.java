...
public class ImageInputStreamTest {
    ...
    private static final Logger LOGGER = Logger.getLogger(ImageInputStreamTest.class.toString());
    ...
    @Test
    public void inflaterInputStream() throws FileNotFoundException, IOException {
    ...
    public void URLImageInputStream() {
        ...
        try {
            ...
            if (TestData.isInteractiveTest()) visualize(image, "testURLImageInputStreamSpi");
            else image.getAsBufferedImage();
        } catch (IOException e) {
            LOGGER.log(Level.SEVERE, e.getLocalizedMessage(), e);
        }
    ...
    public void fileImageInputStreamExtImpl() {
        ...
        try {
            ...
            final ImageInputStream stream = ImageIO.createImageInputStream(url);
            final RenderedOp image = ImageN.create("ImageRead", stream);
            if (TestData.isInteractiveTest()) visualize(image, "testFileImageInputStreamExtImpl");
            else image.getAsBufferedImage();
        } catch (IOException e) {
            LOGGER.log(Level.SEVERE, e.getLocalizedMessage(), e);
        }
