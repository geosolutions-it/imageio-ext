...
public class ImageOutputStreamTest {
    private static final Logger LOGGER = Logger.getLogger(ImageOutputStreamTest.class.toString());
    ...
    public void testOutputStreamAdapter() throws IOException {
        ...
        try (ImageInputStream is = new FileImageInputStream(temp)) {
            ...
            is.read(b);
            Assert.assertArrayEquals("Written and read bytes do not match", testBytes, b);
        }
    }
}
