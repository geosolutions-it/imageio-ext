...
public abstract class GDALImageWriter extends ImageWriter {
	...
	public GDALImageWriter(ImageWriterSpi originatingProvider) {
		...
		driver = getDriver();
		isSupportingCreate = isSupportingCreate();
		isSupportingCreateCopy = isSupportingCreateCopy();
	}
	...
	public void write(IIOMetadata streamMetadata, IIOImage image,
		...
		//
		// /////////////////////////////////////////////////////////////////////
		if (!isSupportingCreate && !isSupportingCreateCopy)
		...
		if (isSupportingCreate) {
		...
		} else if (isSupportingCreateCopy) {
			...
			sourceDataset = reader.getLastRecentlyUsedDataset();
			...
			// some image properties such size, position,...
			//
			// /////////////////////////////////////////////////////////////////
