...
public class GDALCommonIIOImageMetadataFormat extends IIOMetadataFormatImpl implements
	...
	protected GDALCommonIIOImageMetadataFormat() {
		...
		// root -> GCPs
		addElement("GCP", GDALCommonIIOImageMetadata.nativeMetadataFormatName,
				CHILD_POLICY_EMPTY);
		addAttribute("GCP", "GCP", DATATYPE_INTEGER, true, null, "0", null, true,
				false);
		addAttribute("GCP", "GCP", DATATYPE_INTEGER, true, null, "0", null, true,
				false);
		...
		//TODO: insert an additional single node having N children BandInfo
		// root -> BandInfo
		addElement("BandInfo", GDALCommonIIOImageMetadata.nativeMetadataFormatName,
				CHILD_POLICY_SOME);
