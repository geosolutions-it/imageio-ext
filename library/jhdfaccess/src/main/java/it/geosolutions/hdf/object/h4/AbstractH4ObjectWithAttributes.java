 ...
 */
abstract class AbstractH4ObjectWithAttributes extends AbstractHObject implements
        IHObject {

    protected AbstractH4ObjectWithAttributes(final int identifier, final int numAttributes) {
    ...
    public synchronized H4Attribute getAttribute(final int attributeIndex)
        ...
        if (indexToAttributesMap != null
                && !indexToAttributesMap.containsKey(index)) {
