...
public class MLInt32 extends MLNumericArray<Integer>
{
     ...
     * @param type - array type: here <code>mxINT32_CLASS</code>
    ...
    {
        this(name, castToInt( vals ), m );
    }
    /* (non-Javadoc)
     * @see com.jmatio.io.io.types.GenericArrayCreator#createArray(int, int)
     */
     ...
     */
    private static Integer[] castToInt( int[] d )
    {
