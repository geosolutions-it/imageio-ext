...
public final class Grib1TimeRangeIndicator {
    static private HashMap timeRangeIndicator = new HashMap();
     ...
     */
    static {
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(0),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(1),
            "Initialized analysis product for reference time (P1=0).");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(2),
            "Product with a valid time ranging between reference time + P1 and reference time + P2");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(3),
            "Average (reference time + P1 to reference time + P2)");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(4),
            "Accumulation (reference time + P1 to reference time + P2) product considered valid at reference time + P2");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(5),
            "Difference (reference time + P2 minus reference time + P1) product considered valid at reference time + P2");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(6),
            "Average (reference time - P1 to reference time - P2)");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(7),
            "Average (reference time - P1 to reference time + P2)");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(10),
            "P1 occupies octets 19 and 20; product valid at reference time + P1");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(51),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(113),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(114),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(115),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(116),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(117),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(118),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(119),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(123),
            "Average of N uninitialized analyses, starting at the reference time, at intervals of P2.");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(124),
            "Accumulation of N uninitialized analyses, starting at the reference time, at intervals of P2.");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(125),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(128),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(129),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(130),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(131),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(132),
            "Climatological Average of N analyses, each a year apart, starting from initial time R and for the period from R+P1 to R+P2.");
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(133),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(134),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(135),
        ...
        Grib1TimeRangeIndicator.timeRangeIndicator.put(new Integer(136),
    ...
    public static String TimeRangeIndicator(int key) {
        ...
        if (Grib1TimeRangeIndicator.timeRangeIndicator.containsKey(
                new Integer(key))) {
            return (String) Grib1TimeRangeIndicator.timeRangeIndicator.get(new Integer(
                    key));
        }
    ...
    private static boolean checkReserved(int key) {
        for (int i = 0; i < Grib1TimeRangeIndicator.ranges4Reserved.length;
            i++) {
            if ((key >= Grib1TimeRangeIndicator.ranges4Reserved[i][0])
                && (key <= Grib1TimeRangeIndicator.ranges4Reserved[i][1])) {
                return true;
            }
        }
    ...
    public static Map getAll() {
        Map clone = (Map) Grib1TimeRangeIndicator.timeRangeIndicator.clone();

        for (int i = 0; i < Grib1TimeRangeIndicator.ranges4Reserved.length;
            i++) {
            for (int j = Grib1TimeRangeIndicator.ranges4Reserved[i][0];
                j <= Grib1TimeRangeIndicator.ranges4Reserved[i][1]; j++) {
                clone.put(new Integer(j), "reserved");
            }
        }

        return (Map) Grib1TimeRangeIndicator.timeRangeIndicator.clone();
    }
}
;
